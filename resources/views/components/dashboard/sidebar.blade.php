            ...
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item ">
                            <a href="{{ route('user.managements.users.index') }}">User</a>
                        </li>
                        @endcan
                        @can($rolePermissions::INDEX)
                        <li class="submenu-item ">
                            <a href="{{ route('user.managements.roles.index') }}">Peran</a>
                        </li>
                        @endcan
                        @can($permissionPermissions::INDEX)
                        <li class="submenu-item ">
                            <a href="{{ route('user.managements.permissions.index') }}">Izin Akses</a>
                        </li>
                        @endcan
                    </ul>
                </li>
