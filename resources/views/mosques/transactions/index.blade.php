<x-dashboard.layout>
                    ...
                    @foreach ($transactions as $key => $transaction)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-detail-image" data-bs-toggle="modal" data-bs-target="#modal-images" data-transaction="{{ $transaction }}">
                            ...
                            @if(request()->route('type')=='submissions')
                                @can($accessPermissions["MOSQUE_TRANSACTION_APPROVAL"])
                                    <td>
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-success btn-approval"
                                                data-bs-toggle="modal" data-bs-target="#modal-approval"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-add" class="row g-3" method="POST"
                              action="{{ route('mosque.transactions.store', request()->route('mosque_id')) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="file" id="transaction_images[]"
                                       name="transaction_images[]" multiple>
                            </div>
                        </form>
                    </div>
        ...
        <div class=" modal fade" id="modal-approval" tabindex="-1" aria-labelledby="modal-editLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-approval" class="row g-3" method="POST"
                              action="{{ route('mosque.transactions.approval',['mosque_id'=> request()->route('mosque_id'), 'id'=> ':id']) }}">
                            @csrf
                            @method("PUT")
                            <div class="col-md-12">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-images" tabindex="-1" aria-labelledby="modal-images" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3" id="modal-image-detail">
                    </div>
                </div>
            </div>
        </div>
